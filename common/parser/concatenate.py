...
ce3 = "-vgu"
ce4 = "+megnegu"
# nounwords = ['nuteg','elitnaurvig','atkug','uluar','angute','kaviar-*','elitnauriste','ui','neqe','nuna','tuntu']
nounwords = ['kaviallerar','kaviaruar','kaviarenkug','kaviayaar','kaviacuar','kaviarugar','kaviapiar','kaviakegtaar','kaviarpag']
celist = [ce1,ce2,ce3,ce4]

endings = [a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z]
nounendings = ['%:(e)k','%:(e)t','%:(e)nka','-ka',':(6)at',':(6)it',':(6)ak',':(6)a',':(6)i','+pet','-vet','%~mi','%tun']
nounendings = ['-piaq','-kegtaar','-ller','-(6)uaq',':(e)nkuk','~:(6)urtuq','-yagaq','-cuar','-rpak','-rugaq','-rraq']
